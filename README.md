...
This repository contains a number of shaded dependencies for the [Apache Fluss (Incubating)](https://fluss.apache.org/) project.
...
This project is inspired from [flink-shaded](https://github.com/apache/flink-shaded).